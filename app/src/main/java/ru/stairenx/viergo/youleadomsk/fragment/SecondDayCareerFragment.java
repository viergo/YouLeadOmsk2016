 ...
 */
public class SecondDayCareerFragment extends AbstractTabFragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //getProgram();
        program = DataBaseAction.getProgramDay("seconddaycareer");
    ...
    public static SecondDayCareerFragment getInstance(Context context) {
        Bundle args = new Bundle();
        SecondDayCareerFragment fragment = new SecondDayCareerFragment();
        fragment.setArguments(args);
        fragment.setContext(context);
        fragment.setTitle(Constants.TAB_ITEM_SECOND_CAREER);
